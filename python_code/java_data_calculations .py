...
def data_calculations():
    ...
    reg_data = open('end_data\ME_pi400\ME_pi400_RPiOS_lin_times_java.txt', 'r')
    ...
    thread_data = open('end_data\ME_pi400\ME_pi400_RPiOS_thread_times_java.txt', 'r')
    ...
    run_type = ("linear", "Threaded")
    times = (reg_avg, thread_avg)
    ...
    plt.title("Device 5 Java times")
    plt.ylim([0, 60])
    plt.savefig('Final_java_ME_pi400.png')
    # plt.show()
